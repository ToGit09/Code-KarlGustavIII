...
public:
    ...
    movement_event ballanfahrt(ir_sensor_event IR_Data, bool Cornerspeed, bool leftcorner, movement_event move = movement_event())
    {
        ...
        if (abs(IR_Data.Orbit_direction) < 55 && abs(IR_Data.direction) < 30)
...
=======
<<<<<<<< HEAD:src/Karl-GustavIII-v1.1.1.cpp
                // esc.write(50); // Dribbler an              
========
                // esc.write(50); // Dribbler an
>>>>>>>> 24224b29a379650dc961e3b60173fb437100e0d7:releases/Karl-GustavIII-v1.1.1.cpp
>>>>>>> 24224b29a379650dc961e3b60173fb437100e0d7
