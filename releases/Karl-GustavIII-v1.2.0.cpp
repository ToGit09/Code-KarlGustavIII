...
public:
     ...
     */
    movement_event corner(bool isItLeftCorner, int cornerTimerState, bool isCornerUnset, us_sensor_event US, compass_sensor_event comp, movement_event move = movement_event(), ir_sensor_event ir = ir_sensor_event())
    {
        if ((US.dist_f > 30))
...
public:
    ...
    void gameLogik(void)
    {
        ...
        if (IshoouldDefend)
            ...
            move = Tactics.corner(isItLeftCorner, CornerTimer, cornerisUnset, US, Compass, move, IR), StatusR = 0, StatusG = 200, StatusB = 255;
